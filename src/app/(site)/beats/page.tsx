...
import { toBrowseGridItem } from "@/lib/serializers/marketplace-beat";
import { BeatsFilters } from "@/features/beats/BeatsFilters";
import { BeatsQuickFilters } from "@/features/beats/BeatsQuickFilters";
import BeatsGridClient from "@/features/beats/BeatsGridClient";
import { hasActiveDiscoveryFilters } from "@/features/beats/beats-query";
...
export default async function BeatsPage({ searchParams }: BeatsPageProps) {
  ...
  const beatsWithPrices = result.beats.map(toBrowseGridItem);
    ...
    <div className="page-shell">
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start">
        ...
        <div className="flex-1">
          <BeatsQuickFilters currentFilters={params} />
          {beatsWithPrices.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              {hasActiveDiscoveryFilters(params) && (
                <Link
                  href="/beats"
